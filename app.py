...
with st.form("entry_form"):
    ...
    with col2:
        ...
        effective_ppm = st.number_input("Effective Dosage ppm (measured)", 0.0, 1000.0, step=0.1)
    ...
    if submitted:
        ...
        if abs(total_fiber - 100.0) > 0.1:
            ...
            new_entry = pd.DataFrame([{
                ...
                "Effective_Dosage_ppm" : effective_ppm,
